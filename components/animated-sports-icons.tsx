...
export function AnimatedSportsIcons() {
  ...
  useEffect(() => {
    ...
    if (iconsRef.current.length === 0) {
      const icons = [
        { key: 0, element: <Football className="text-indigo-500" /> },
        { key: 1, element: <Tennis className="text-purple-500" /> },
        { key: 2, element: <Target className="text-indigo-400" /> },
        { key: 3, element: <Dices className="text-purple-400" /> },
        { key: 4, element: <Trophy className="text-indigo-300" /> },
        { key: 5, element: <Timer className="text-purple-300" /> },
        { key: 6, element: <Flag className="text-indigo-200" /> },
        { key: 7, element: <Shirt className="text-purple-200" /> },
        { key: 8, element: <Whistle className="text-indigo-100" /> },
        { key: 9, element: <Racquet className="text-purple-100" /> },
      ]
