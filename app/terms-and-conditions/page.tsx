...
export const metadata = {
  title: "Terms and Conditions | Best Irish Betting Sites",
  description: "Read our terms and conditions for using the Best Irish Betting Sites website.",
}
      ...
      <section className="pt-28 pb-12 bg-white flex-grow">
        <div className="container mx-auto px-4">
          ...
          <div className="prose max-w-4xl">
            ...
            <p>
              Please review these Terms and Conditions thoroughly before accessing or using the BestBettingIrishSite.com
              website.
            </p>
            ...
            <p>
              The information provided on BestBettingIrishSite.com is intended solely for general informational
              purposes. While we endeavor to maintain current and accurate information, we offer no representations or
              warranties, whether express or implied, regarding the completeness, accuracy, reliability, suitability, or
            ...
            <p>
              BestBettingIrishSite.com participates in affiliate partnerships with various betting operators. We may
            ...
            <p>
              Unless otherwise specified, BestBettingIrishSite.com and/or its licensors maintain ownership of all
            ...
            <p>
              Under no circumstances shall BestBettingIrishSite.com, or any of its officers, directors, or employees,
            ...
            <p>
              ...
              team at info@bestirishbettingsite.com.
            </p>
          </div>
        </div>
      </section>
